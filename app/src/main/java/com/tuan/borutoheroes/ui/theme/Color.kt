package com.tuan.borutoheroes.ui.theme
...
val LightSplashStartGradient = Color(0xFF43CBFF)
val LightSplashEndGradient = Color(0xFF9708CC)
val DarkSplashStartGradient = Color(0xFF28313B)
val DarkSplashEndGradient = Color(0xFF485461)
...
val Colors.shimmerEffectItemColor
    @Composable
    get() = if (isLight) ShimmerLightGray else Color.Black

val Colors.shimmerEffectPlaceholderColor
    @Composable
    get() = if (isLight) ShimmerMediumGray else ShimmerDarkGray

val Colors.errorScreenMessageColor
    @Composable
    get() = if (isLight) DarkGray else LightGray